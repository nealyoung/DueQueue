...
Assignment.create(:title => 'Resume Draft', :notes => 'In-class peer review on Thursday', :due => '2013-1-17', :course_id => 15)
Assignment.create(:title => 'Resume Final', :due => '2013-1-22', :course_id => 15)
Assignment.create(:title => 'Personal Statement Draft', :notes => 'Bring paper copy to class', :due => '2013-1-29', :course_id => 15)
Assignment.create(:title => 'Personal Statement Final', :due => '2013-2-12', :course_id => 15)
Assignment.create(:title => 'Pitch Presentation', :notes => 'Submit slides to EEE Dropbox by 12:20AM day of presentation', :due => '2013-2-14', :course_id => 15)
Assignment.create(:title => 'Wikipedia Draft', :due => '2013-2-12', :course_id => 15)
